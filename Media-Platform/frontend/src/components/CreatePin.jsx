...
const CreatePin = ({user}) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      {fields && (
        <p className="text-red-500 mb-5 text-xl transcation-all duration-150 ease-in">
          Please fill the fields </p>
      )}
             ...
             {!imageAsset? (
               <label> 
                 <div className="flex flex-col items-center justify-center h-full"> 
                    ...
                    Use higher quality JPG, SVG, PNG, GIF less than 25 MB</p>
                 </div>
                 <input
                 type="file"
                 name="upload-image"
